...
export const protosemUpdates = [
  ...
  { id: "week-6", title: "Week 6: Microcontrollers & Soldering", subtitle: "Had a two-day session on microcontrollers and microprocessors, covering in-depth architecture and concepts of embedded systems. Learned how to solder and successfully soldered a 555 timer IC chip with LEDs, resistors, and a capacitor.", type: "development", date: "Week 6" },
  { 
    id: "week-7", 
    title: "Week 7: IoT & Connectivity", 
    subtitle: "Hands-on sessions using Arduino IDE and ESP32. Task 1: writing code to make the inbuilt LED on the ESP32 blink on command from a website using HTTP. Task 2: controlling a 230W bulb connected to a relay using MQTT. Task 3: controlling the same bulb using voice activation via IFTTT.", 
    type: "development", 
    date: "Week 7",
    href: "/iot-session",
    linkLabel: "View IoT Session Details"
  },
