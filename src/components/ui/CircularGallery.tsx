...
class Media {
  extra: number; geometry: any; gl: any; image: string; index: number; length: number; renderer: any; scene: any; screen: any; text: string; viewport: any; bend: number; textColor: string; borderRadius: number; font: string; program: any; plane: any; title: any; speed: number = 0; isBefore: boolean = false; isAfter: boolean = false; widthTotal: number = 0; width: number = 0; x: number = 0; scale: number = 0; padding: number = 0;
...
class App {
  container: any; scrollSpeed: number; scroll: any; onItemClick?: (index: number) => void;
  onCheckDebounce: any; renderer: any; gl: any; camera: any; scene: any; planeGeometry: any;
  mediasImages: any; medias: Media[] = []; screen: any; viewport: any; isDown: boolean = false;
  start: number = 0; raf: number = 0; raycast: any; mouse: any; boundOnResize: any; boundOnWheel: any;
  boundOnTouchDown: any; boundOnTouchMove: any; boundOnTouchUp: any; boundOnKeyDown: any; boundOnClick: any;
  ...
  onClick(e: any) {
    ...
    this.mouse.set(
      2.0 * (x / rect.width) - 1.0,
      2.0 * (1.0 - y / rect.height) - 1.0
    );
    ...
    if (hits.length > 0) {
      ...
      if (clickedMedia) {
        this.onItemClick(clickedMedia.index % this.originalLength);
      }
    }
  }
  onWheel(e: any) {
    ...
    switch (e.key) {
      ...
      case 'Enter':
        ...
        if (this.onItemClick && this.medias && this.medias[0]) {
           ...
           this.onItemClick(itemIndex % this.originalLength);
        }
        break;
      default:
        break;
