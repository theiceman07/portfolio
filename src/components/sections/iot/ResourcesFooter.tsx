        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 mb-12">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3">
              {[
                { name: 'Adafruit IO Docs', url: 'https://io.adafruit.com/api/docs/' },
                { name: 'MQTT Specification', url: 'https://mqtt.org/mqtt-specification/' },
                { name: 'IFTTT Developer Portal', url: 'https://ifttt.com/developer' },
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <a href={siteConfig.githubUrl} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-gray-400 hover:bg-accent hover:text-white transition-all hover:scale-110">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg>
              </a>
              <a href={siteConfig.linkedinUrl} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-gray-400 hover:bg-[#0077B5] hover:text-white transition-all hover:scale-110">
              ...
              <a href={`mailto:${siteConfig.email}`} className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-gray-400 hover:bg-red-500 hover:text-white transition-all hover:scale-110">
